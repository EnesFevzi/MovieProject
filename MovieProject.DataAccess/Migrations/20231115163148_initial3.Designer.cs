...
namespace MovieProject.DataAccess.Migrations
{
    ...
    [Migration("20231115163148_initial3")]
            ...
            modelBuilder.Entity("MovieProject.Entity.Entities.Actor", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ActorId = 1,
                            CreatedDate = new DateTime(2023, 11, 15, 19, 31, 48, 439, DateTimeKind.Local).AddTicks(9196),
                            Name = "Morgan Freeman"
                        },
                        new
                        {
                            ActorId = 2,
                            CreatedDate = new DateTime(2023, 11, 15, 19, 31, 48, 439, DateTimeKind.Local).AddTicks(9205),
                            Name = "Tom Holland"
                        },
                        new
                        {
                            ActorId = 3,
                            CreatedDate = new DateTime(2023, 11, 15, 19, 31, 48, 439, DateTimeKind.Local).AddTicks(9206),
                            Name = "Cillian Murphy"
                        });
                });
            ...
            modelBuilder.Entity("MovieProject.Entity.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            CategoryId = 1,
                            CreatedDate = new DateTime(2023, 11, 15, 19, 31, 48, 439, DateTimeKind.Local).AddTicks(9325),
                            Name = "Komedi"
                        },
                        new
                        {
                            CategoryId = 2,
                            CreatedDate = new DateTime(2023, 11, 15, 19, 31, 48, 439, DateTimeKind.Local).AddTicks(9327),
                            Name = "Bilim Kurgu"
                        },
                        new
                        {
